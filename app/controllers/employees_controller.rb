class EmployeesController < ApplicationController
  ...
  def new
    ...
    @employee.cardRFID = params[:cardRFID] if params[:cardRFID].present? # Define o valor do cartão RFID no objeto @employee se estiver presente nos parâmetros da URL
